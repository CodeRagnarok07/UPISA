        ...
        <div id="step_1">
            ...
            <div className="flex  gap-4 flex-wrap justify-between items-center mt-12">
                ...
                <label class="flex    items-center gap-1 md:gap-4 md:ml-auto md:mr-4" >
                    ...
                    <div class="p-2 lg:p-3 flex justify-center items-center w-[1.75] h-[1.75] bg-primary rounded-full" style={{ borderRadius: "100%" }}>
                    ...
                    <div className="w-[50px]  p-1 md:p-4  bg-white rounded-lg border border-orange-100 justify-center items-center gap-2 inline-flex">
                        <input name="cantidad" type="number" id="input_cant_0" class="noarrow " />
                    </div>
