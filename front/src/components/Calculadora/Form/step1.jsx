const MyApp = () => {
    return (
        <div id="step_1">
            ...
            <div className="flex  gap-4 flex-wrap justify-between items-center mt-12">
                ...
                {/* CANTIDAD  */}
                <label class="flex    items-center gap-1 md:gap-4 md:ml-auto md:mr-4" >

                    <div class="p-2 lg:p-3  cursor-pointer flex justify-center items-center w-[1.75] h-[1.75] bg-primary rounded-full" style={{ borderRadius: "100%" }}>
                    ...
                    <div className="w-[50px]  p-1 md:p-4  bg-white rounded-lg border border-orange-100 justify-center items-center gap-2 inline-flex">
                        <input name="cantidad" value={1} type="number"  class="noarrow " />
                    </div>
                ...
                <div class=" flex ">
                    <div class="p-1 md:p-4 border bg-white border-[#FAE0C9]  flex items-center justify-end rounded-lg">
                        <input name="porcion" disabled="" id="g_value" class="h-full w-max inline items-center" value="500" type="number" />g
