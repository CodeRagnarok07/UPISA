    ...
    return (
        ...
        <div className="cont">
            ...
            <div className="carrusel-slider mt-12">
                ...
                <div className="slider slider-grid" style={{"--grid":"2","--grid-md":"4"}}>

                    <div className="item-grid px-2 flex ">
                        <a className="z-50 rounded-xl w-full
                            bg-white text-black 
                            flex flex-col justify-between"
                            href="{% url 'product_detail' i.sub_categoria.categoria.url i.url %}">
                    ...
                    mt-12 flex-center " id="min_{{i.id}}">
                                <img className="h-full w-full object-contain" src="{{i.miniatura.url}}" alt=""/>
                            </figure>


                            <p className="p-4 md:p-9 uppercase text-center font-semibold">
                                producto
                            </p>
                        </a>
                ...
                <div className="dot-control my-6 lg:my-16">
                </div>
