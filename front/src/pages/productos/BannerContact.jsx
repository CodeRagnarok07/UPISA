...
import imgBaner from 'src/assets/contact_link.png'
// import imgBaner from 'src/assets/cerdo/6.png'

const BanerContact=()=>{
    return(
        <div class="flex flex-col w-full rounded-xl mt-20 mb-10 bg-white lg:flex-row-reverse lg:justify-between ">

                    <img class="lg:w-1/2 rounded-t-xl lg:rounded-t-none lg:rounded-r-xl object-cover"

                        src={imgBaner} alt="" />

                    <div class="lg:w-1/2 m-5 lg:m-12 lg:flex lg:flex-col lg:items-start lg:justify-center">

                        <h3 class="font-bold">
                            ¿NO ENCONTRÁS LO QUE BUSCÁS? ESTAMOS PARA AYUDARTE
                        </h3>

                        <NavLink to={"/contacto"} className="btn bg-primary flex justify-center items-center mt-6 gap-4 lg:mr-auto w-full lg:w-auto" href="#">
