...
const MyApp = () => {
    ...
    const data = [
        {
            img: img1,
            titulo: "APORTE DE PROTEÍNAS",
            text: "Como con la mayoría de alimentos cárnicos, la carne de este animal aporta proteínas de alta calidad, necesarias para el correcto desarrollo muscular."
        },
        {
            img: img2,
            titulo: "APORTE DE AMINOÁCIDOS ESENCIALES",
            text: "Los aminoácidos esenciales son aquellos que no puede producir el cuerpo humano por sí mismo. Son realmente importantes para el buen funcionamiento del organismo y únicamente pueden conseguirse a través de la alimentación. La carne de cerdo contiene algunos de estos aminoácidos que la convierten en una elección alimenticia muy interesante."
        },
        {
            img: img3,
            titulo: "ÁCIDOS GRASOS MONOINSATURADOS",
            text: "El cuerpo humano necesita consumir grasas para estar sano. Las grasas monoinsaturadas son saludables y buenas para la salud. Se pueden encontrar en ciertos alimentos: nueces, aguacates, pescado y en la carne de cerdo."
        },
        {
            img: img4,
            titulo: "AYUDA A CIERTAS NECESIDADES NUTRICIONALES",
            text: "En algunos momentos de la vida, es necesario cuidar la alimentación por diversos motivos. Uno de ellos es el periodo de embarazo y lactancia. La carne de cerdo cuenta con una gran cantidad de proteínas que te ayudarán a generar los nutrientes necesarios para este momento."
        },
        {
            img: img5,
            titulo: "COMPLEMENTO IDEAL PARA EL DEPORTE",
            text: "Para aquellas personas que hacen deporte y, en especial, para las que buscan hacer hipertrofia muscular, la carne de cerdo es perfecta. Este tipo de carne permite a los deportistas conseguir las proteínas suficientes para hacer crecer sus músculos. A su vez, la carne de cerdo ayuda a los deportistas a conseguir las grasas saludables necesarias."
        },
    ...
    return (
        <article class="cont mt-16 mb-20 ">
            ...
            <div id="novedades" class="grid grid-cols-1 mt-6 gap-6 sm:grid-cols-2 xl:grid-cols-3">

                {data.map((v, k) => (

                    <div class="bg-white rounded-xl text-black h-auto ">
                        <img class="rounded-t-xl object-center h-[200px] md:h-[300px] lg:h-[423px] w-full object-cover"
                            src={v.img} alt="" />
                        <div class="p-5 md:p-9">
                            <h4 class="uppercase mb-4">{v.titulo}</h4>
                            <p>
                                {v.text}
                            </p>
                        </div>
            ...
            <div class="flex">
                <NavLink to="/recetas/" className="btn cursor-pointer bg-primary z-50 mt-16 flex items-center gap-2">
