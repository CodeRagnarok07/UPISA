...
const RecetaDetail = ({ params }) => {

    const { url } = useParams()
    const {data, isLoading} = useQueryFetcher(["product", url], "api/posts/receta/" + url)

    return (
        !isLoading && data.current &&
        <Layer
            header={{ title: `${data.current.nombre}`, text: "" }}
            ...
            <section className='cont mt-10 mb-32'>
                ...
                <div class="flex flex-col gap-4 lg:flex-row">
                    ...
                    <div className='flex flex-col gap-4 w-full'>
                        <h2 class="text-left capitalize">{data.current.nombre}</h2>
                        ...
                        <div class="flex gap-6 mt-5 mb-8 ">
                            <div class="flex items-center gap-[10px]">
                                ...
                                <p class="">{data.current.tiempo_preparacion}</p>
                            </div>
                            ...
                            <div class="flex items-center gap-[10px]">
                                ...
                                <p class="">{data.current.porcion_personas} personas</p>
                            </div>
                        </div>

                        <p dangerouslySetInnerHTML={{ __html: data.current.descripcion }} />
                    ...
                    {data.current.galeria.length &&
                        <Carrusel data={data.current.galeria} />
                    }
                ...
                <div className='mt-12'>
                    ...
                    <h4 className='mb-4'>PRODUCTOS SUGERIDOS</h4>

                    <div className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 rounded-2xl'>
                        {data.current.productos_sugeridos?.map((v, k) => (
                            <div className='flex items-center gap-4 bg-white p-2'>
                                <img className='w-[5rem] h-auto' src={v.miniatura} alt="" />
                                <h5>
                                    {v.nombre}
                                </h5>
                            </div>
