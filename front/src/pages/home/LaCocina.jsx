...
const LaCocina = () => {
    ...
    const usequery = useQueryFetcher('api/posts/receta/?limit=5')
    ...
    return (
        <div className="cont my-20">
            ...
            <div className="carrusel-slider my-8  min-h-[25rem]">
                ...
                <div ref={CarruselRef} className="slider relative     ">
                    {/* SLIDER */}
                    ...
                    {usequery?.data?.results?.map((v, k) => (
                        ...
                        <div className="item-slider ">
                            ...
                            <div className=" h-full w-full flex flex-col lg:flex-row lg:items-center">
                                ...
                                <div className="w-full z-10 -mb-2 lg:m-0 lg:w-4/5 ">
                                    <img className="w-full object-cover rounded-t-2xl lg:rounded-2xl
                                    h-[12.5rem]
                                    sm:h-[19.5rem]
                                    md:h-[25.5rem]
                                    lg:h-[35.5rem]
                                ...
                                <div className="bg-white rounded-lg  text-black p-5 h-min lg:-ml-[6%] lg:z-20 ">
                                    ...
                                    <div className="flex gap-6 mb-6 ">
                                        ...
                                        <div className="flex items-center gap-[10px]">
                                            ...
                                            <p className="">{v.tiempo_preparacion}</p>
                                        </div>
                                        ...
                                        <div className="flex items-center gap-[10px]">
                                            ...
                                            <p className="">{v.porcion_personas}porciones por persona</p>
                                        </div>
                ...
                <div className="hidden lg:flex z-50 absolute bottom-[-2%] inset-x-0 w-full  justify-center lg:w-auto left-auto lg:right-[15%] lg:bottom-[20%]">
                    <div className="controls-side  gap-4 " style={{ display: "flex" }}>
                    ...
                    <div ref={dotControlerRef} className="dot-control my-4">
                        <div ></div>
                    </div>
