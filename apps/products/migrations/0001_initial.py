    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_categoria', models.ForeignKey(help_text='Busqueda por Categoria superior', on_delete=django.db.models.deletion.CASCADE, related_query_name='products', to='products.categoriasub')),
            ],
            options={
                'ordering': ['-id'],
            },
