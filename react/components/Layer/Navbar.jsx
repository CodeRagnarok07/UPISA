...
export default function Navbar() {
  ...
  const content = {
    title: "Productos",
    description: `Conocé la amplia línea de fiambres y embutidos frescos que tenemos para vos, con calidad y sabor único. ¡Tenés que probarlo!
  ...
  return (
    ...
    <div className={`${styles.navbar} ${styles.bg}`}>
      ...
      <ul>
        <a className="" href="{% url 'index' %}">INICIO</a>
        <a className="" href="{% url 'empresa' %}">LA EMPRESA</a>
        <a className="" href="{% url 'products' %}">PRODUCTOS</a>
        <a className="" href="{% url 'parrilleros' %}">PARRILLEROS</a>
        <figure className=""><a href=""><img src='/static/img/Logo.png' alt="" /></a></figure>
        <a className="" href="{% url 'novedades' %}">NOVEDADES</a>
        <a className="" href="{% url 'recetas' %}">RECETAS</a>
        <a className="" href="{% url 'contacto' %}">CONTACTO</a>
        <div className="" href="">Español</div>
      </ul>
